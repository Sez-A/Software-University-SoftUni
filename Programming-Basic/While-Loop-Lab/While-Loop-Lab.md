...
2. В **while** цикъл, до въвеждане на командата **"Stop"**, четете нова дума и я принтирайте на конзолата:
...
2. Инициализирайте променлива **sum**, в която ще добавяме прочетените числа:
...
3. **Принтирайте сумата на числата,** когато тя стане равна или по-голяма от първоначално въведеното число:
...
2. В **while** цикъл до достигане на **n**, пресмятайте ново число от редицата и го принтирайте:
